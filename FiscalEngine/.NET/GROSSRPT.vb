...
10845: 
		...
		ColumnNm(1) = CSng("OILPROD")
		ColumnNm(2) = CSng(" OILPRC")
		ColumnNm(3) = CSng(" OILREV")
		ColumnNm(4) = CSng("GASPROD")
		ColumnNm(5) = CSng(" GASPRC")
		ColumnNm(6) = CSng(" GASREV")
		ColumnNm(7) = CSng("OV1PROD")
		ColumnNm(8) = CSng(" OV1PRC")
		ColumnNm(9) = CSng(" OV1REV")
		ColumnNm(10) = CSng("OV2PROD")
		ColumnNm(11) = CSng(" OV2PRC")
		ColumnNm(12) = CSng(" OV2REV")
		ColumnNm(13) = CSng("OV3PROD")
		ColumnNm(14) = CSng(" OV3PRC")
		ColumnNm(15) = CSng(" OV3REV")
		ColumnNm(16) = CSng("OV4PROD")
		ColumnNm(17) = CSng(" OV4PRC")
		ColumnNm(18) = CSng(" OV4REV")
		ColumnNm(19) = CSng("OV5PROD")
		ColumnNm(20) = CSng(" OV5PRC")
		ColumnNm(21) = CSng(" OV5REV")
		ColumnNm(22) = CSng("OV6PROD")
		ColumnNm(23) = CSng(" OV6PRC")
		ColumnNm(24) = CSng(" OV6REV")
		ColumnNm(25) = CSng("OV7PROD")
		ColumnNm(26) = CSng(" OV7PRC")
		ColumnNm(27) = CSng(" OV7REV")
		ColumnNm(28) = CSng("OV8PROD")
		ColumnNm(29) = CSng(" OV8PRC")
		ColumnNm(30) = CSng(" OV8REV")
		ColumnNm(31) = CSng("OV9PROD")
		ColumnNm(32) = CSng(" OV9PRC")
		ColumnNm(33) = CSng(" OV9REV")
		ColumnNm(34) = CSng("OV0PROD")
		ColumnNm(35) = CSng(" OV0PRC")
		ColumnNm(36) = CSng(" OV0REV")
		' GDP 20 Jan 2003
...
10847: ColumnNm(1) = CSng("EQUPROD")
		ColumnNm(2) = CSng(" EQUPRC")
		ColumnNm(3) = CSng(" EQUREV")
		ColumnNm(4) = CSng("    OX1")
		ColumnNm(5) = CSng("    OX2")
		ColumnNm(6) = CSng("    OX3")
		ColumnNm(7) = CSng("    OX4")
		...
		'ColumnNm$(9) = "TOTOPEX"
		ColumnNm(9) = CSng("    OX6")
		ColumnNm(10) = CSng("    OX7")
		ColumnNm(11) = CSng("    OX8")
		ColumnNm(12) = CSng("    OX9")
		ColumnNm(13) = CSng("    OX0")
		ColumnNm(14) = CSng("    O11")
		ColumnNm(15) = CSng("    O12")
		ColumnNm(16) = CSng("    O13")
		ColumnNm(17) = CSng("    O14")
		ColumnNm(18) = CSng("    O15")
		ColumnNm(19) = CSng("    O16")
		ColumnNm(20) = CSng("    O17")
		ColumnNm(21) = CSng("    O18")
		ColumnNm(22) = CSng("    O19")
		ColumnNm(23) = CSng("    O20")
		ColumnNm(24) = CSng("TOTOPEX")
		ColumnNm(25) = CSng("EQUPRODVOL")
...
12190: 'SET OTHER VARIABLES
		...
		ColumnNm(1) = CSng("SIGBONS")
		ColumnNm(2) = CSng("DISBONS")
		ColumnNm(3) = CSng("PROBONS")
		ColumnNm(4) = CSng("    BNS")
		ColumnNm(5) = CSng("    LSE")
		ColumnNm(6) = CSng("    REN")
		ColumnNm(7) = CSng(" TOTEXP")
		ColumnNm(8) = CSng(" TOTDEV")
		ColumnNm(9) = CSng("    CP1")
		ColumnNm(10) = CSng("    CP2")
		ColumnNm(11) = CSng("    CP3")
		ColumnNm(12) = CSng("    CP4")
		ColumnNm(13) = CSng("    CP5")
		ColumnNm(14) = CSng("    CP6")
		ColumnNm(15) = CSng("    CP7")
		ColumnNm(16) = CSng("    CP8")
		ColumnNm(17) = CSng("    CP9")
		ColumnNm(18) = CSng("    ABN")
		
		'<<<<<< 6 Aug 2001 JWD (C0373)
		ColumnNm(19) = CSng("    " & CPXCategoryCodeString_AbandonmentCashExpenditure)
		ColumnNm(20) = CSng(" TOTCAP")
		'~~~~~~ was:
		''<<<<<< 2 Aug 2001 JWD (C0363)
