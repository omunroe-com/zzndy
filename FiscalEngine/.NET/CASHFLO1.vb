...
24000: 'THIS CALCULATES PRESENT VALUES AND ROR
		...
		'UPGRADE_ISSUE: GoSub statement is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="C5A1A479-AB8B-4D40-AAF4-DB19A2E5E77F"'
		GoSub 27100 ' CALCULATES ESPV(1 - 13,6) FOR ECONOMIC SUMMARY PAGE
		
		GoTo 30000
		
		'--------------------------------------------------------------------
		'THIS IS A GOSUB   (called from 27230 and 27255)
26200: 'THIS CALCULATES PAYOUT - PAY(X) COMES IN AND POT GOES OUT
		iZR = Y3 - YR + 1
		' Added 1/24/00
...
26320: 'UPGRADE_WARNING: Return has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
		Return 
		
		
		'--------------------------------------------------------------------
27000: ' This subroutine sets up for discounting...
...
27099: Next i ' target of GoTo !!!!!
		...
		Return 
		'--------------------------------------------------------------------
27100: ' THIS CALCULATES ESPV(1 - 13,6) FOR ECONOMIC SUMMARY PAGE
		
		'UPGRADE_ISSUE: GoSub statement is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="C5A1A479-AB8B-4D40-AAF4-DB19A2E5E77F"'
		GoSub 27000 ' accumulate discountable cashflows
...
27218: 
		...
		'XR = 0
		'GoSub 27500       'to skip govt ROR, comment out this call
		'   ' RRB = GOVT ROR
		'RRB = RRZ
		'
...
27300: '  THIS CALCULATES U1 - U8 FOR A GIVEN DISCOUNT RATE
		...
		'UPGRADE_ISSUE: GoSub statement is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="C5A1A479-AB8B-4D40-AAF4-DB19A2E5E77F"'
		GoSub 28000
		U11 = U11 - vpr(0) ' Add to operating cash flow
		U12 = 0 ' No capital expenditures for government
		For i = 1 To LG
			GOVT(i) = GOVT(i) - vpr(i)
		Next i
		...
		'---------------------------------------------------------------------
27400: ' This drives discounting for ROR calculation
...
27500: 
		...
		'UPGRADE_ISSUE: GoSub statement is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="C5A1A479-AB8B-4D40-AAF4-DB19A2E5E77F"'
		GoSub 27400 'CALCULATES U5 FOR A GIVEN DISCOUNT RATE
		TP1 = U5
		If TP1 <= 0 Then
			RRZ = 0
		End If
...
27799: 'UPGRADE_WARNING: Return has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
		Return 
...
28420: 'Check to see if flag set for Discount Date being prior to Project Start Date
		...
		If DiscFlag = 1 Then
			...
			If DiscMthd = 1 Then
				Y3 = TempDiscYr
				M3 = TempDiscMo
				DiscTime = DateProj - DateDisc 'discounting time if Discounting Method = FRC
			Else
				Y3 = TempDiscYr
				DiscTime = YR - Y3 'discounting time if Discounting Method <> FRC
			End If
