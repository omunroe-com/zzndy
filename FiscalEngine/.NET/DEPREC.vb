...
1330: 'UPGRADE_ISSUE: GoSub statement is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="C5A1A479-AB8B-4D40-AAF4-DB19A2E5E77F"'
			GoSub 11050 ' this reads Misc. screen and sets DeprStrt, Year1 & DBSL
...
4839: 'UPGRADE_WARNING: Return has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
		Return 
...
4840: ' NOW APPLY CEILING TO DEPRECIATION
		...
		For iZZ = 1 To LG
			DEPR(iZZ) = rDum(iZZ)
		Next iZZ
4999: 'UPGRADE_WARNING: Return has a new behavior. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="9B7D5ADD-D8FE-4819-A36C-6DEDAF088CC7"'
		Return 
		'--------------------------------------------------------------------
