Option Strict Off
Option Explicit On
Interface _CReportText
	Function SectionTitle(ByVal PageTypeID As Short) As String
	Function RowTitle(ByVal PageTypeID As Short, ByVal RowID As Short) As String
	Function RowUnit(ByVal PageTypeID As Short, ByVal RowID As Short) As String
	 Property ForecastTitle(ByVal ForecastCode As String) As String
End Interface
Friend Class CReportText
	...
	Public Function SectionTitle(ByVal PageTypeID As Short) As String Implements _CReportText.SectionTitle
	...
	Public Function RowTitle(ByVal PageTypeID As Short, ByVal RowID As Short) As String Implements _CReportText.RowTitle
...
RowTitle_Error: 
	...
	Public Function RowUnit(ByVal PageTypeID As Short, ByVal RowID As Short) As String Implements _CReportText.RowUnit
	...
	Public Property ForecastTitle(ByVal ForecastCode As String) As String Implements _CReportText.ForecastTitle
		Get
