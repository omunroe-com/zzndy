...
'
Public Sub AddCapitalExpenditure( _
            ByVal ExpenditureCode As Integer, _
            ByVal ExpenditureMonth As Integer, _
            ByVal ExpenditureYear As Integer, _
            ByVal TangiblePercentage As Single, _
            ByVal GrossExpenditureAmount As Single, _
            ByVal ApplicableWorkingInterest As Single, _
            ByVal ExpenditureReimbursementPercentage As Single)
