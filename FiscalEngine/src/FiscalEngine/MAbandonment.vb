...
Module MAbandonment
	...
	Const zzz_WIN As Short = -998
	
	' 10 Sep 2002 JWD (C0588)
	Public Const OnChangeOfProjectLifeForLicenseTerm As Integer = 4
	
	' 12 Set 2002 JWD (C0592)
	Public Const OnChangeOfProjectLifeForEconomicLimit As Integer = 6
	...
	Private zzz_StartTriggerParameters() As Short
	...
	' 0 = earliest
	' 1 = latest
	Private zzz_StartTriggerFunction As Short
	
	' When the funding starts relative to the period in which
	' the trigger occurs
	' 0 = same period
	' 1 = next period
	Private zzz_StartOption As Short
	...
	'>>>>>> End 25 Jul 2001 JWD
	Private zzz_Method As Short
	
	'<<<<<< 25 Jul 2001 JWD (C0357)
	' Symbols for different methods
	Private Const zzz_Method_Straightline As Short = 1
	Private Const zzz_Method_UnitOfProduction As Short = 2
	Private Const zzz_Method_DecliningBalance As Short = 3
	'>>>>>> End (C0357)
	...
	Private Const zzz_MethodParameterDefaultValue_Straightline As Short = 0
	Private Const zzz_MethodParameterDefaultValue_UnitOfProduction As Short = 1
	Private Const zzz_MethodParameterDefaultValue_DecliningBalance As Short = 100
	...
	' limit.
	Private zzz_AbandonmentExpenditurePeriodOffset As Short
	...
	' effect.
	Private zzz_CashAccrualOption As Short
	' Following are the values that the above may assume.
	Private Const zzz_CashAccrualOption_Cash As Short = 1
	Private Const zzz_CashAccrualOption_Accrual As Short = 2
	'
	Private Const zzz_CashAccrualOption_Default As Short = zzz_CashAccrualOption_Cash
	'>>>>>> End (C0363)
	...
	Sub ApplyAbandonmentFundingProvisions()
		...
		Dim start_period As Short
		Dim number_of_periods As Short
	...
	Public Sub InitializeAbandonmentExpenditureData()
		...
		'UPGRADE_WARNING: Lower bound of array zzz_InflationForecast was changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="0F1C9BE1-AF9D-476E-83B1-17D43BECFF20"'
		ReDim zzz_InflationForecast(gc_nMAXLIFE)
		'>>>>>> End (C0355)
	...
	Public Sub InitializeAbandonmentFundingProvisions()
		...
		ReDim zzz_StartTriggerParameters(0)
		ReDim zzz_StartTriggerParameterValues(0)
		...
		'<<<<<< 1 Aug 2001 JWD (C0363)
		'UPGRADE_WARNING: Couldn't resolve default property of object zzz_CashAccrualOption_Default. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
	...
	'
	Public Sub ReadAbandonmentFundingProvisions(ByVal FileHandle As Integer)
		...
		Input(FileHandle, number)
		'UPGRADE_WARNING: Lower bound of array zzz_StartTriggerParameters was changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="0F1C9BE1-AF9D-476E-83B1-17D43BECFF20"'
		ReDim zzz_StartTriggerParameters(number)
		'UPGRADE_WARNING: Lower bound of array zzz_StartTriggerParameterValues was changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="0F1C9BE1-AF9D-476E-83B1-17D43BECFF20"'
		ReDim zzz_StartTriggerParameterValues(number)
	...
	'
	Public Sub ReadAbandonmentInflationData(ByVal FileHandle As Integer)
	...
	'
	Public Sub SetAbandonmentExpenditurePeriodOffset(ByVal NewValue As Short)
	...
	' period number.
	'
	Private Sub zzzDecliningBalance(ByVal ExpenditureCategoryCode As Short, ByVal FundingStartPeriod As Short, ByVal NumberOfPeriods As Short, ByVal TotalAmount As Single, ByVal DecliningBalanceRate As Single)
	...
	' occurs (1-LG).
	'
	Private Function zzzGetEventPeriod(ByRef Parameter As Short, ByRef Value As Single) As Short
		
		Dim i As Short
		Dim event_period As Short
		...
		Select Case Parameter
			...
			Case 4 ' cumulative oil production
                ...
                event_period = zzzGetEventPeriod_Cumulative(Value, vector)
			...
			Case 8 ' cumulative equivalent production (price equivalence)
                the_volume = zzzGetEventPeriod_Equivalent(vector)
				cumulative = 0
				event_period = LG
				'<<<<<< 30 Jul 2001 JWD (C0359)
			...
			Case 9 ' percent of oil reserves
				vector = 1
				'UPGRADE_ISSUE: GoSub statement is not supported. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="C5A1A479-AB8B-4D40-AAF4-DB19A2E5E77F"'
                event_period = zzzGetEventPeriod_Percent(Value, vector)
    ...
    Function zzzGetEventPeriod_Cumulative(ByVal value As Single, ByVal vector As Short) As Short
    ...
    Function zzzGetEventPeriod_Percent(ByVal value As Single, ByVal vector As Short) As Short
    ...
    Function zzzGetEventPeriod_Equivalent(ByVal vector As Single) As Single()
        Dim i As Short
        ...
        End If
        '>>>>>> End (C0360)
        'UPGRADE_WARNING: Lower bound of array the_volume was changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="0F1C9BE1-AF9D-476E-83B1-17D43BECFF20"'
        Dim the_volume(LG) As Single
        For i = 1 To LG
            '<<<<<< 30 Jul 2001 JWD (C0360)
            ...
            Else
                ...
                the_volume(i) = ((A(i, gc_nAOIL) * A(i, gc_nAOPC)) + (A(i, gc_nAGAS) * A(i, gc_nAGPC)) + (A(i, gc_nAOV1) * A(i, gc_nAOP1)) + (A(i, gc_nAOV2) * A(i, gc_nAOP2)) + (A(i, gc_nAOV3) * A(i, gc_nAOP3)) + (A(i, gc_nAOV4) * A(i, gc_nAOP4)) + (A(i, gc_nAOV5) * A(i, gc_nAOP5)) + (A(i, gc_nAOV6) * A(i, gc_nAOP6)) + (A(i, gc_nAOV7) * A(i, gc_nAOP7)) + (A(i, gc_nAOV8) * A(i, gc_nAOP8)) + (A(i, gc_nAOV9) * A(i, gc_nAOP9)) + (A(i, gc_nAOV0) * A(i, gc_nAOP0))) / A(i, vector)
            End If
            '~~~~~~ was:
    ...
    ' periods.
    '
    Private Function zzzGetInflatedFutureValueFactor(ByVal ThePeriod As Integer) As Double

        Dim i As Integer
        Dim return_value As Double
        Dim the_limit As Integer
    ...
    ' occurs.
    '
    Private Function zzzGetTriggerPeriod() As Short

        Dim i As Short
        Dim event_period As Short
        Dim periodX As Short
    ...
    ' period number.
    '
    Private Sub zzzStraightline(ByVal ExpenditureCategoryCode As Short, ByVal FundingStartPeriod As Short, ByVal NumberOfPeriods As Short, ByVal TotalAmount As Single)
    ...
    ' period number.
    '
    Private Sub zzzUnitOfProduction(ByVal ExpenditureCategoryCode As Short, ByVal FundingStartPeriod As Short, ByVal NumberOfPeriods As Short, ByVal TotalAmount As Single, ByVal UOPStreamCode As Short)
        ...
        Select Case UOPStreamCode
            Case 1 ' Total production - price equivalence
                For i = 1 To LG
                    ...
                    uop_vol(i) = (A(i, gc_nAOIL) * A(i, gc_nAOPC)) + (A(i, gc_nAGAS) * A(i, gc_nAGPC)) + (A(i, gc_nAOV1) * A(i, gc_nAOP1)) + (A(i, gc_nAOV2) * A(i, gc_nAOP2)) + (A(i, gc_nAOV3) * A(i, gc_nAOP3)) + (A(i, gc_nAOV4) * A(i, gc_nAOP4)) + (A(i, gc_nAOV5) * A(i, gc_nAOP5)) + (A(i, gc_nAOV6) * A(i, gc_nAOP6)) + (A(i, gc_nAOV7) * A(i, gc_nAOP7)) + (A(i, gc_nAOV8) * A(i, gc_nAOP8)) + (A(i, gc_nAOV9) * A(i, gc_nAOP9)) + (A(i, gc_nAOV0) * A(i, gc_nAOP0))
            ...
            Case 2 ' Total production - energy equivalence
                ...
                For i = 1 To LG
                    ...
                    dTotalOilProduction = A(i, gc_nAOIL) + A(i, gc_nAOV1) + A(i, gc_nAOV3) + A(i, gc_nAOV5) + A(i, gc_nAOV7) + A(i, gc_nAOV9)

                    dTotalGasProduction = A(i, gc_nAGAS) + A(i, gc_nAOV2) + A(i, gc_nAOV4) + A(i, gc_nAOV6) + A(i, gc_nAOV8) + A(i, gc_nAOV0)
        ...
        'UPGRADE_WARNING: Lower bound of array periodic_rate_factor was changed from 1 to 0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="0F1C9BE1-AF9D-476E-83B1-17D43BECFF20"'
        ReDim periodic_rate_factor(LG)
    ...
    '
    '
    Public Sub TriggerAbandonmentProvisionsModelEvent(ByVal TheEvent As Integer)

        Dim z_method As Integer
