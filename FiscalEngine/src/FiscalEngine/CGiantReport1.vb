...
Friend Class CGiantReport1
    ...
    Public Property ReportText() As CReportText
        Get
    ...
    Private Property CReportText_ForecastTitle(ByVal ForecastCode As String) As String
        Get
    ...
    Private Function CReportText_RowTitle(ByVal PageTypeID As Short, ByVal RowID As Short) As String
    ...
    Private Function CReportText_RowUnit(ByVal PageTypeID As Short, ByVal RowID As Short) As String
    ...
    Private Function CReportText_SectionTitle(ByVal PageTypeID As Short) As String
    ...
    ' done.
    '
    Private Function IVariableTitlesA_IsUserVariable(ByVal VariableCode As String) As Boolean Implements IVariableTitlesA.IsUserVariable
    ...
    ' symbols TL$() & TLT.
    '
    Private Function IVariableTitlesA_LongTitle(ByVal VariableCode As String) As String Implements IVariableTitlesA.LongTitle
