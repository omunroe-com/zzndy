Option Strict Off
Option Explicit On
Friend Class CGiantRptPageG1
    Implements IDGiantRptPageG
    ...
    '
    Private Const m_lClassID As Integer = 7
    ...
    Private Property IDGiantRptPageG_Headers() As String() Implements IDGiantRptPageG.Headers
        Get
            IDGiantRptPageG_Headers = VB6.CopyArray(ma_sTitles)
        End Get
    ...
    Private Property IDGiantRptPageG_PageHeader() As CGiantRptPageHdr1 Implements IDGiantRptPageG.PageHeader
        Get
            IDGiantRptPageG_PageHeader = m_oHeader
        End Get
    ...
    Private Property IDGiantRptPageG_Values() As Single() Implements IDGiantRptPageG.Values
        Get
            IDGiantRptPageG_Values = VB6.CopyArray(ma_rValues)
        End Get
    ...
    Private Property IDGiantRptPageG_VariableCode() As String Implements IDGiantRptPageG.VariableCode
        Get
    ...
    '
    Private Sub IGiantRptPageAssignSub_SetPageHeader(ByVal PageType As Short, ByVal startyear As Short, ByVal PageCount As Short, ByVal ProjectLife As Short, ByVal ProfileCount As Short, ByVal PageTitle As String, ByVal ColumnWidth As Short, ByVal FinalWorkingInt As Single, ByVal FinalParticipation As Single, ByVal PageCurrency As String) Implements IGiantRptPageAssignSub.SetPageHeader
    ...
    Private Sub IGiantRptPageAssignSub_SetProfileHeaders(ByVal ParamArray ProfileNames() As Object) Implements IGiantRptPageAssignSub.SetProfileHeaders
    ...
    Private Sub IGiantRptPageAssignSub_SetProfileValues(ByVal RowIndex As Short, ByVal ParamArray ProfileValues() As Object) Implements IGiantRptPageAssignSub.SetProfileValues
    ...
    Private Sub IGiantRptPageAssignSub_SetRptPageVariableCode(ByVal VariableCode As String) Implements IGiantRptPageAssignSub.SetRptPageVariableCode
