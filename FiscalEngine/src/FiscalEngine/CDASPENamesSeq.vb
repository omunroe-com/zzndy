Option Strict Off
Option Explicit On
Friend Class CDASPENamesSeq
    Implements IDStore
    Implements IDStoreSeq
	
	
	
    Private ma_sNames(,) As String
	...
	Public Sub Initialize(ByVal Rows As Integer, ByVal Columns As Integer)
		...
		'UPGRADE_WARNING: Lower bound of array ma_sNames was changed from 1,1 to 0,0. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="0F1C9BE1-AF9D-476E-83B1-17D43BECFF20"'
		ReDim ma_sNames(Rows, Columns)
		ResetCursor()
	...
	Public ReadOnly Property AllNames() As String()
		Get
			AllNames = VB6.CopyArray(ma_sNames)
		End Get
	End Property
    ...
    Private WriteOnly Property NextItem() As Object Implements IDStoreSeq.NextItem
        Set(ByVal Value As Object)
            ...
            ma_sNames(m_lRow, m_lColumn) = Value
