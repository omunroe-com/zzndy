...
BEGIN
	...
	IF (SELECT MODIFIED_BY FROM COMPANY_HEADER WHERE PU_ID = @PU_ID) != 'IHS'
		RETURN -- No action required
	...
	BEGIN TRY
		...
		UPDATE COMPANY_HEADER SET MODIFIED_BY='USER' WHERE PU_ID = @PU_ID;
...
BEGIN
	...
	IF (SELECT MODIFIED_BY FROM COMPANY_HEADER WHERE PU_ID = @PU_ID) != 'USER'
		RETURN -- No action required
	...
	BEGIN TRY
		...
		UPDATE COMPANY_HEADER SET MODIFIED_BY='IHS' WHERE PU_ID = @PU_ID;
