IF EXISTS (SELECT name FROM sys.objects WHERE type='P' AND name='PROC_CLONE_FIELD')
	DROP PROCEDURE [PROC_CLONE_FIELD]
GO
CREATE PROCEDURE [PROC_CLONE_FIELD] @FIE_ID DECIMAL (12,0), @NEW_FIE_ID DECIMAL (12,0) OUTPUT
AS
BEGIN
	SET NOCOUNT ON
...
GRANT EXEC ON [PROC_CLONE_FIELD] TO [abu]
GO

IF EXISTS (SELECT name FROM sys.objects WHERE type='P' AND name='PROC_CLONE_BLOCK')
	DROP PROCEDURE [PROC_CLONE_BLOCK]
GO
CREATE PROCEDURE [PROC_CLONE_BLOCK] @GA_ID DECIMAL (12,0), @NEW_GA_ID DECIMAL (12,0) OUTPUT
AS
BEGIN
	SET NOCOUNT ON
...
GRANT EXEC ON [PROC_CLONE_BLOCK] TO [abu]
GO

IF EXISTS (SELECT name FROM sys.objects WHERE type='P' AND name='PROC_CLONE_COMPLEX')
	DROP PROCEDURE [PROC_CLONE_COMPLEX]
GO
CREATE PROCEDURE [PROC_CLONE_COMPLEX] @FIELD_COMPLEX_ID DECIMAL (12,0), @NEW_FIELD_COMPLEX_ID DECIMAL (12,0) OUTPUT
AS
BEGIN
	SET NOCOUNT ON
...
GRANT EXEC ON [PROC_CLONE_COMPLEX] TO [abu]
GO

IF EXISTS (SELECT name FROM sys.objects WHERE type='P' AND name='PROC_CLONE_COMPANY')
	DROP PROCEDURE [PROC_CLONE_COMPANY]
GO
CREATE PROCEDURE [PROC_CLONE_COMPANY] @PU_ID DECIMAL (12,0), @NEW_PU_ID DECIMAL (12,0) OUTPUT
AS
BEGIN
	SET NOCOUNT ON
...
GRANT EXEC ON [PROC_CLONE_COMPANY] TO [abu]
GO

IF EXISTS (SELECT name FROM sys.objects WHERE type='P' AND name='PROC_CLONE_FISCAL_TERMS')
	DROP PROCEDURE [PROC_CLONE_FISCAL_TERMS]
GO
CREATE PROCEDURE [PROC_CLONE_FISCAL_TERMS] @TAX_SYSTEM_ID DECIMAL (12,0), @NEW_TAX_SYSTEM_ID DECIMAL (12,0) OUTPUT
AS
BEGIN
	SET NOCOUNT ON
...
GRANT EXEC ON [PROC_CLONE_FISCAL_TERMS] TO [abu]
GO