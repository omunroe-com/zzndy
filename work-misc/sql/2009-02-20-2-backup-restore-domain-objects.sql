...
BEGIN
	...
	BEGIN TRY
		...
		DELETE FROM INV_ASS_TUPLE_DATA_SHADOW
			...
			(
				SELECT FIELD_PHASE_DEVELOPMENT_SHADOW.INV_ASS
...
BEGIN
	...
	BEGIN TRY
		...
		DELETE FROM INV_ASS
			...
			(
				SELECT FIELD_PHASE_DEVELOPMENT.INV_ASS
